...
my $check = CheckTemplateDir->new( template_dir_path    =>  "$FindBin::RealBin/data",
                                 , suffix => '.tpl'
                                 );
...
$check = CheckTemplateDir->new( template_dir_path    => 'A/Non/Existing/Dir',
                              , suffix => '.tpl'
                              );
...
$check = CheckTemplateDir->new( template_dir_path    => "$FindBin::RealBin/data",
                              , suffix => '.ABSENT'
                              );
...
is(ref ($check->validate_directory), 'Path::Tiny', 'validate directory returns a Path::Tiny object for the validated dir');
